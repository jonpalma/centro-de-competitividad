...
<div class="wrapper premio" id="premio">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <div class="img-container">
                        <img class="banner-bg" src="<?php echo bloginfo('template_url').'/'; ?>img/cc-premio/banner/1.jpg" alt="Banner">
                    </div>
                    <div class="container">
                        <div class="vertical-align text-center white">
                            <img class="logo" src="<?php echo bloginfo('template_url').'/'; ?>img/cc-premio/banner/logo1.png" alt="CChCP">
                            <h1>
                                AUMENTA TU PRODUCTIVIDAD Y MEJORA LA
    ...
    <section class="descripcion spacing">
        <div>
            <h1>
                ¿QUÉ ES EL PREMIO CHIHUAHUA A LA COMPETITIVIDAD?
            </h1>
            <p>
                Tiene como objetivo impulsar el desarrollo de nuestra comunidad,
                apoyando la cultura de mejora continua y calidad en las empresas
                a través de la implementación del Modelo Nacional para la Competitividad,
                desarrollando así empresas de clase mundial.
            </p>
        </div>
    </section>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        ...
        <div class="container light-spacing">
            ...
            <div class="col-sm-8">
                ...
                <ul type='disk'>
                    <li>
                        <p>
                            Obtienen un autodiagnóstico de su empresa sobre los
                            principios del Modelo Nacional para la Competitividad.
                        </p>
                    </li>
                    <li>
                        <p>
                            Reciben un reporte de retroalimentación por parte del equipo
                            evaluador de las áreas sólidas y de oportunidad, para
                            continuar en su camino hacia la excelencia.
                        </p>
                    </li>
                    <li>
                        <p>
                            Generan ventajas competitivas a través de la administración
                            por calidad total.
                        </p>
                    </li>
                    <li>
                        <p>
                            Reconocer, motivar y fortalecer su capital humano para el
                            logro de los objetivos de la empresa.
                        </p>
                    </li>
                    <li>
                        <p>
                            Aspirar al Premio Nacional de Competitividad.
                        </p>
                    </li>
                </ul>
            </div>
    ...
    <section class="modelo">
        ...
        <div class="container light-spacing panel-group" id="premioGroup-1" role="tablist" aria-multiselectable="true">
            ...
            <p class="text">
                Es un marco de referencia que sirve como guía para el
            ...
            <a data-toggle="collapse" data-parent="#premioGroup-1" href="#collapse-1"
               aria-expanded="true" aria-controls="collapse-1">
                <div class="col-sm-6 panel panel-default">
                    <div class="col-sm-3">
                        <img src="<?php echo bloginfo('template_url').'/'; ?>img/cc-premio/icons/1.png" alt="">
                    </div>
                    <div class="col-sm-9">
                        <h3>
            ...
            <a class="collapsed" data-toggle="collapse" data-parent="#premioGroup-1" href="#collapse-2"
               aria-expanded="false" aria-controls="collapse-2">
                <div class="col-sm-6 panel panel-default">
                    <div class="col-sm-3">
                        <img src="<?php echo bloginfo('template_url').'/'; ?>img/cc-premio/icons/2.png" alt="">
                    </div>
                    <div class="col-sm-9">
                        <h3>
            ...
            <a class="collapsed" data-toggle="collapse" data-parent="#premioGroup-1" href="#collapse-3"
               aria-expanded="false" aria-controls="collapse-3">
                <div class="col-sm-6 panel panel-default">
                    <div class="col-sm-3">
                        <img src="<?php echo bloginfo('template_url').'/'; ?>img/cc-premio/icons/3.png" alt="">
                    </div>
                    <div class="col-sm-9">
                        <h3>
                            LOGRO DE RESULTADOS
            ...
            <a class="collapsed" data-toggle="collapse" data-parent="#premioGroup-1" href="#collapse-4"
               aria-expanded="false" aria-controls="collapse-4">
                <div class="col-sm-6 panel panel-default">
                    <div class="col-sm-3">
                        <img src="<?php echo bloginfo('template_url').'/'; ?>img/cc-premio/icons/4.png" alt="">
                    </div>
                    <div class="col-sm-9">
                        <h3>
            ...
            <a class="collapsed" data-toggle="collapse" data-parent="#premioGroup-1" href="#collapse-5"
               aria-expanded="false" aria-controls="collapse-5">
                <div class="col-sm-6 panel panel-default">
                    <div class="col-sm-3">
                        <img src="<?php echo bloginfo('template_url').'/'; ?>img/cc-premio/icons/5.png" alt="">
                    </div>
                    <div class="col-sm-9">
                        <h3>
                            ENFOQUE AL CLIENTE
            ...
            <a class="collapsed" data-toggle="collapse" data-parent="#premioGroup-1" href="#collapse-6"
               aria-expanded="false" aria-controls="collapse-6">
                <div class="col-sm-6 panel panel-default">
                    <div class="col-sm-3">
                        <img src="<?php echo bloginfo('template_url').'/'; ?>img/cc-premio/icons/6.png" alt="">
                    </div>
                    <div class="col-sm-9">
                        <h3>
            ...
            <a class="collapsed" data-toggle="collapse" data-parent="#premioGroup-1" href="#collapse-7"
               aria-expanded="false" aria-controls="collapse-7">
                <div class="col-sm-6 panel panel-default">
                    <div class="col-sm-3">
                        <img src="<?php echo bloginfo('template_url').'/'; ?>img/cc-premio/icons/7.png" alt="">
                    </div>
                    <div class="col-sm-9">
                        <h3>
            ...
            <a class="collapsed" data-toggle="collapse" data-parent="#premioGroup-1" href="#collapse-8"
               aria-expanded="false" aria-controls="collapse-8">
                <div class="col-sm-6 panel panel-default">
                    <div class="col-sm-3">
                        <img src="<?php echo bloginfo('template_url').'/'; ?>img/cc-premio/icons/8.png" alt="">
                    </div>
                    <div class="col-sm-9">
                        <h3>
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <section class="conoce spacing">
        <div class="container vertical-align">
            <h1>
                CONÓCE MÁS DE LAS EMPRESAS GANADORAS DEL
