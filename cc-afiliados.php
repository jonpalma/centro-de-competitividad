...
<div class="wrapper afiliados" id="afiliados">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <div class="img-container">
                        <img class="banner-bg" src="img/cc-afiliados/banner/1.jpg" alt="Banner">
                    </div>
                    <div class="container">
                        <div class="vertical-align text-center white">
                            <img class="logo" src="img/cc-afiliados/banner/cchcp.png" alt="CChCP">
                            <h1>
    ...
    <section class="formulario spacing">
        <div class="img-container">
            <img src="img/cc-afiliados/formulario/bg.jpg" alt="">
        </div>
